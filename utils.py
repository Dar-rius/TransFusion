...
def train_test_divide_torch(data_x, data_x_hat, data_t, data_t_hat, train_rate = 0.8, convert_to_tensor:bool = False):
  """Divide train and test data for both original and synthetic data.
  ...
  train_x_hat = torch.from_numpy(train_x_hat).float()
  test_x = torch.from_numpy(test_x).float()
  test_x_hat = torch.from_numpy(test_x_hat).float()
